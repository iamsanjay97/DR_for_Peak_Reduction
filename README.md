...
The branch contains the code for demand response experiments. It has various tariff publication code snippets in PortfolioManagerService.java along with data collection code snippets in MessageManagerService.java. 
